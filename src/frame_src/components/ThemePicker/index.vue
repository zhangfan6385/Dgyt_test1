<template>
  ...
  <el-dropdown trigger="click" class='international' @command="handleSetLanguage">
    ...
    <el-dropdown-menu slot="dropdown">
      <el-dropdown-item command="#3A8EE6">
        <div class="dropItem">
          <div class="rect blue"></div>
          <div class="span">蓝</div>
        </div>
      </el-dropdown-item>
      <el-dropdown-item command="#C03639">
        <div class="dropItem">
          <div class="rect red"></div>
          <div class="span">红</div>
        </div>
      </el-dropdown-item>
      <el-dropdown-item command="#30B08F">
        <div class="dropItem">
          <div class="rect green"></div>
          <div class="span">绿</div>
        </div>
      </el-dropdown-item>
      <el-dropdown-item command="#909399">
        <div class="dropItem">
          <div class="rect gray"></div>
          <div class="span">灰</div>
        </div>
      </el-dropdown-item>
...
export default {
    ...
    created() {
        this.STYLE = this.$store.state.user.themClass;
        //console.log(this.STYLE + "DD");
    },
    mounted() {
        //this.handleSetColour();
    },
